...
class Matricula
{
    ...
    {
        return (string)"Matricula{" . "cedula_alumno=" . $this->cedula_alumno . ", nombre=" . $this->nombre . ", telefono=" . $this->telefono . ", email=" . $this->email . ", fecha_nacimiento=".$this->fech_nac .   '}';//falta el valor de carrera pero no deja por extension
    }
}
